...
def parse():
    ...
    parser.add_argument('--aug_ratio', type=float, default=0.7)
    ...
    parser.add_argument('--dataset', nargs='?', default='inscart_1')
    ...
    parser.add_argument('--cl_reg', type=float, default=1e-1)
